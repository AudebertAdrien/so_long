...
/*   Updated: 2023/04/12 16:12:10 by aaudeber         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (vars->exit_parsed == 1 && \
			vars->collectible_parsed == vars->count_collectible)
		return (1);
...
void	is_exit_reachable(t_vars *vars)
{
	...
	if (!res)
		is_map_error(vars, "Pathfinding isn't reachable");
